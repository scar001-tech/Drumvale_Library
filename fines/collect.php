...
@media print {
    ...
    .page-header, .page-actions, .main-nav, .main-footer, .btn, .page-hero, .form-container {
        display: none !important;
    }
    .page-container {
        padding: 0 !important;
