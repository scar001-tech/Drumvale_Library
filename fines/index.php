...
<div class="page-container">
    <div class="page-header">
        <div class="page-actions">
            ...
            <a href="../reports/fines.php" class="btn btn-secondary">
    ...
    <?php if ($total_fines > 0 && $total_pages > 1 && !$view_all): ?>
